                ...
                <div class="image-gallery mb-5">
                    <div class="row g-3">
                        <div class="col-md-4 col-6">
                            <img src="img/r1.jpg" alt="The Rock Restaurant 1" class="img-fluid rounded">
                        </div>
                        <div class="col-md-4 col-6">
                            <img src="img/r2.jpg" alt="The Rock Restaurant 2" class="img-fluid rounded">
                        </div>
                        <div class="col-md-4 col-6">
                            <img src="img/r3.jpg" alt="The Rock Restaurant 3" class="img-fluid rounded">
                        </div>
                        <div class="col-md-4 col-6">
                            <img src="img/r4.jpg" alt="The Rock Restaurant 4" class="img-fluid rounded">
                        </div>
                        <div class="col-md-4 col-6">
                            <img src="img/r5.jpg" alt="The Rock Restaurant 5" class="img-fluid rounded">
                        </div>
                        <div class="col-md-4 col-6">
                            <img src="img/r6.jpg" alt="The Rock Restaurant 6" class="img-fluid rounded">
                        </div>
                    </div>
                </div>
                <div class="text-center">
                    <p class="mb-4">
                        <b>Experience</b>: Enjoy a wide selection of fresh seafood, including lobster, prawns, and octopus, while being surrounded by panoramic ocean views. The Rock Restaurant is perfect for romantic dinners, special occasions, or simply experiencing one of Zanzibar's most unique settings.
                    </p>
                    <a class="btn btn-primary rounded-pill py-3 px-5" href="booking.html">Reserve Your Table Now</a>
                </div>
            </div>
        </div>
    </div>
